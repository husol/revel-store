...
func (r *HusCaptcha) Verify(recaptchaResponse string) bool {
	return r.VerifyResponse(recaptchaResponse)
}
...
func (r *HusCaptcha) VerifyResponse(response string) bool {
...
func (r HusCaptcha) LastError() []string {
	return r.lastError
}
